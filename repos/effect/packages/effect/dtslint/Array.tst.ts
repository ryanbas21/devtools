...
describe("Array", () => {
  ...
  it("map", () => {
    ...
    expect(
      Array.map(nonEmptyReadonlyStrings, (s, i) => {
        expect(s).type.toBe<string>()
        expect(i).type.toBe<number>()
        return s + "a"
      })
  ...
  it("groupBy", () => {
    ...
    expect(
      Array.groupBy([1, 2, 3], (n) =>
        n > 0 ? ("positive" as const) : ("negative" as const)
      )
    ).type.toBe<Record<string, [number, ...Array<number>]>>()
  ...
  it("some", () => {
    expect(
      Array.some(numbersOrStrings, (item, i) => {
    ...
    if (Array.some(numbersOrStrings, Predicate.isString)) {
      expect(numbersOrStrings).type.toBe<
        Array<string | number> &
          readonly [string | number, ...Array<string | number>]
      >()
    }
  })
  ...
  it("sort", () => {
    ...
    expect(pipe(nonEmptyABs, Array.sort(orderA))).type.toBe<
      [AB, ...Array<AB>]
    >()
  ...
  it("sortWith", () => {
    ...
    expect(
      Array.sortWith(ABs, identity, (a, b) => {
        expect(a).type.toBe<AB>()
        expect(b).type.toBe<AB>()
        return 0
      })
    ...
    expect(
      Array.sortWith(nonEmptyABs, identity, (a, b) => {
        expect(a).type.toBe<AB>()
        expect(b).type.toBe<AB>()
        return 0
      })
  ...
  it("partition", () => {
    expect(
      Array.partition(numbersOrStrings, (item, i) => {
        expect(item).type.toBe<string | number>()
        expect(i).type.toBe<number>()
        return true
      })
  ...
  it("filter", () => {
    expect(
      Array.filter(numbersOrStrings, (item, i) => {
        expect(item).type.toBe<string | number>()
        expect(i).type.toBe<number>()
        return true
      })
    ...
    expect(Array.filter(numbers, predicateNumbersOrStrings)).type.toBe<
      Array<number>
    >()
    expect(pipe(numbers, Array.filter(predicateNumbersOrStrings))).type.toBe<
      Array<number>
    >()
    ...
    expect(Array.filter(numbersOrStrings, Predicate.isNumber)).type.toBe<
      Array<number>
    >()
    expect(pipe(numbersOrStrings, Array.filter(Predicate.isNumber))).type.toBe<
      Array<number>
    >()
  })
  ...
  it("takeWhile", () => {
    ...
    expect(Array.takeWhile(numbers, predicateNumbersOrStrings)).type.toBe<
      Array<number>
    >()
    expect(pipe(numbers, Array.takeWhile(predicateNumbersOrStrings))).type.toBe<
      Array<number>
    >()
    ...
    expect(Array.takeWhile(numbersOrStrings, Predicate.isNumber)).type.toBe<
      Array<number>
    >()
    expect(
  ...
  it("liftPredicate", () => {
    ...
    expect(
      pipe(
        primitiveNumberOrString,
        Array.liftPredicate(predicateNumbersOrStrings)
      )
    ).type.toBe<Array<string | number>>()
    expect(
  ...
  it("dropWhile", () => {
    expect(
      Array.dropWhile(numbersOrStrings, (item, i) => {
        expect(item).type.toBe<string | number>()
        expect(i).type.toBe<number>()
        return true
      })
    ...
    expect(Array.dropWhile(numbers, predicateNumbersOrStrings)).type.toBe<
      Array<number>
    >()
    expect(pipe(numbers, Array.dropWhile(predicateNumbersOrStrings))).type.toBe<
      Array<number>
    >()

    expect(
      Array.dropWhile(numbersOrStrings, predicateNumbersOrStrings)
    ).type.toBe<Array<string | number>>()
    expect(
      pipe(numbersOrStrings, Array.dropWhile(predicateNumbersOrStrings))
    ).type.toBe<Array<string | number>>()
  ...
  it("flatten", () => {
    // Mutable arrays
    expect(Array.flatten(hole<Array<Array<number>>>())).type.toBe<
      Array<number>
    >()
    expect(Array.flatten(hole<Array<Array.NonEmptyArray<number>>>())).type.toBe<
      Array<number>
    >()
    expect(Array.flatten(hole<Array.NonEmptyArray<Array<number>>>())).type.toBe<
      Array<number>
    >()
    expect(
      Array.flatten(
    ...
    expect(Array.flatten([[arg1], [arg2]])).type.toBe<
      Array.NonEmptyArray<Eff<R1 | R2> | Eff<R1 | R2 | R3>>
    >()
    expect(Array.flatten([[arg2], [arg1]])).type.toBe<
      Array.NonEmptyArray<Eff<R1 | R2> | Eff<R1 | R2 | R3>>
    >()
  })
  ...
  it("prependAll", () => {
    // Array + Array
    expect(Array.prependAll(strings, numbers)).type.toBe<
      Array<string | number>
    >()
    expect(pipe(strings, Array.prependAll(numbers))).type.toBe<
      Array<string | number>
    >()
    ...
    // Iterable + Array
    expect(Array.prependAll(iterStrings, numbers)).type.toBe<
      Array<string | number>
    >()
    expect(pipe(iterStrings, Array.prependAll(numbers))).type.toBe<
      Array<string | number>
    >()
    ...
    // Array + Iterable
    expect(Array.prependAll(numbers, iterStrings)).type.toBe<
      Array<string | number>
    >()
    expect(pipe(numbers, Array.prependAll(iterStrings))).type.toBe<
      Array<string | number>
    >()
  ...
  it("appendAll", () => {
    // Array + Array
    expect(Array.appendAll(strings, numbers)).type.toBe<
      Array<string | number>
    >()
    expect(pipe(strings, Array.appendAll(numbers))).type.toBe<
      Array<string | number>
    >()
    ...
    // Iterable + Array
    expect(Array.appendAll(iterStrings, numbers)).type.toBe<
      Array<string | number>
    >()
    expect(pipe(iterStrings, Array.appendAll(numbers))).type.toBe<
      Array<string | number>
    >()
    ...
    // Array + Iterable
    expect(Array.appendAll(numbers, iterStrings)).type.toBe<
      Array<string | number>
    >()
    expect(pipe(numbers, Array.appendAll(iterStrings))).type.toBe<
      Array<string | number>
    >()
  ...
  it("zip", () => {
    ...
    expect(pipe(strings, Array.zip(numbers))).type.toBe<
      Array<[string, number]>
    >()
  ...
  it("intersperse", () => {
    ...
    expect(pipe(strings, Array.intersperse(1))).type.toBe<
      Array<string | number>
    >()
    expect(Array.intersperse(1)(strings)).type.toBe<Array<string | number>>()

    expect(Array.intersperse(nonEmptyStrings, "a")).type.toBe<
      [string, ...Array<string>]
    >()
    expect(pipe(nonEmptyStrings, Array.intersperse("a"))).type.toBe<
      [string, ...Array<string>]
    >()
    expect(Array.intersperse("a")(nonEmptyStrings)).type.toBe<
      [string, ...Array<string>]
    >()
  ...
  it("rotate", () => {
    ...
    expect(Array.rotate(nonEmptyStrings, 10)).type.toBe<
      [string, ...Array<string>]
    >()
    expect(pipe(nonEmptyStrings, Array.rotate(10))).type.toBe<
      [string, ...Array<string>]
    >()
    expect(Array.rotate(10)(nonEmptyStrings)).type.toBe<
      [string, ...Array<string>]
    >()
  })
  ...
  it("union", () => {
    ...
    expect(pipe(strings, Array.union(numbers))).type.toBe<
      Array<string | number>
    >()
  ...
  it("dedupe", () => {
    ...
    // NonEmptyArray
    expect(Array.dedupe(nonEmptyStrings)).type.toBe<
      [string, ...Array<string>]
    >()
    expect(pipe(nonEmptyStrings, Array.dedupe)).type.toBe<
      [string, ...Array<string>]
    >()
  })
  ...
  it("chunksOf", () => {
    // Array
    expect(Array.chunksOf(strings, 10)).type.toBe<
      Array<[string, ...Array<string>]>
    >()
    expect(pipe(strings, Array.chunksOf(10))).type.toBe<
      Array<[string, ...Array<string>]>
    >()
    expect(Array.chunksOf(10)(strings)).type.toBe<
      Array<[string, ...Array<string>]>
    >()
  ...
  it("window", () => {
    ...
    expect(pipe(nonEmptyStrings, Array.window(two))).type.toBe<
      Array<Array<string>>
    >()
    ...
    expect(Array.window(nonEmptyStrings, 2)).type.toBe<
      Array<[string, string]>
    >()
    expect(pipe(nonEmptyStrings, Array.window(2))).type.toBe<
      Array<[string, string]>
    >()
    expect(Array.window(2)(nonEmptyStrings)).type.toBe<
      Array<[string, string]>
    >()
  })
  ...
  it("reverse", () => {
    ...
    // NonEmptyArray
    expect(Array.reverse(nonEmptyStrings)).type.toBe<
      [string, ...Array<string>]
    >()
    expect(pipe(nonEmptyStrings, Array.reverse)).type.toBe<
      [string, ...Array<string>]
    >()
  })
  ...
  it("separate", () => {
    ...
    expect(Array.separate([Either.right(1)])).type.toBe<
      [Array<never>, Array<number>]
    >()
    expect(Array.separate([Either.left("a")])).type.toBe<
    ...
    expect(
      Array.separate(
        hole<
          Iterable<Either.Either<number, string> | Either.Either<boolean, Date>>
        >()
      )
    ...
    expect(
      Array.separate(
        hole<
          | Iterable<Either.Either<number, string>>
          | Iterable<Either.Either<boolean, Date>>
        >()
      )
    ).type.toBe<[Array<string | Date>, Array<number | boolean>]>()
  })
  ...
  it("getRights", () => {
    ...
    expect(Array.getRights([Either.left("a"), Either.right(1)])).type.toBe<
      Array<number>
    >()
    expect(
  ...
  it("getLefts", () => {
    ...
    expect(Array.getLefts([Either.left("a"), Either.right(1)])).type.toBe<
      Array<string>
    >()
    expect(
  ...
  it("getSomes", () => {
    ...
    expect(Array.getSomes([Option.none(), Option.some(1)])).type.toBe<
      Array<number>
    >()
    expect(Array.getSomes(hole<Array<Option.Option<number>>>())).type.toBe<
      Array<number>
    >()
    expect(Array.getSomes(hole<Iterable<Option.Option<number>>>())).type.toBe<
      Array<number>
    >()
    expect(
      Array.getSomes(
        hole<Iterable<Option.Option<number> | Option.Option<string>>>()
      )
    ).type.toBe<Array<string | number>>()
    expect(
      Array.getSomes(
        hole<
          Iterable<Option.Option<number>> | Iterable<Option.Option<string>>
        >()
      )
    ).type.toBe<Array<string | number>>()
  })
  ...
  it("replace", () => {
    ...
    expect(pipe(numbers, Array.replace(0, "a"))).type.toBe<
      Array<string | number>
    >()
  ...
  it("replaceOption", () => {
    expect(Array.replaceOption([], 0, "a")).type.toBe<
    ...
    expect(pipe([], Array.replaceOption(0, "a"))).type.toBe<
      Option.Option<Array<string>>
    >()
  ...
  it("modify", () => {
    ...
    // NonEmptyArray
    expect(
      Array.modify(nonEmptyNumbers, 0, (n) => {
        expect(n).type.toBe<number>()
        return "a" as const
      })
    ...
    // Iterable
    expect(
      Array.modify(new Set([1, 2] as const), 0, (n) => {
  ...
  it("modifyOption", () => {
    ...
    // Array
    expect(
      Array.modifyOption(numbers, 0, (n) => {
        expect(n).type.toBe<number>()
        return "a"
      })
    ...
    // NonEmptyArray
    expect(
      Array.modifyOption(nonEmptyNumbers, 0, (n) => {
        expect(n).type.toBe<number>()
        return "a" as const
      })
    ).type.toBe<Option.Option<[number | "a", ...Array<number | "a">]>>()
    ...
    // Iterable
    expect(
      Array.modifyOption(new Set([1, 2] as const), 0, (n) => {
        expect(n).type.toBe<1 | 2>()
        return "a" as const
      })
    ).type.toBe<Option.Option<Array<"a" | 1 | 2>>>()
  ...
  it("mapAccum", () => {
    // Array
    expect(
      Array.mapAccum(strings, 0, (s, a, i) => {
    ...
    // NonEmptyArray
    expect(
      Array.mapAccum(nonEmptyReadonlyStrings, 0, (s, a, i) => {
        expect(s).type.toBe<number>()
        expect(a).type.toBe<string>()
        expect(i).type.toBe<number>()
        return [s + i, a]
