...
describe("Record", () => {
  it("NonLiteralKey", () => {
    ...
    ).type.toBe<`a${string}b${string}`>()
    expect(
      hole<Record.ReadonlyRecord.NonLiteralKey<`a${number}`>>()
    ).type.toBe<`a${number}`>()
    expect(
      hole<
        Record.ReadonlyRecord.NonLiteralKey<`a${number}b${string}c${number}`>
      >()
    ).type.toBe<`a${number}b${string}c${number}`>()
  })

  it("empty", () => {
    expect(Record.empty<never>()).type.not.toBeAssignableTo<
      Record<"a", number>
    >()
    ...
    expect(Record.empty<`a${string}bc`>()).type.toBe<
      Record<`a${string}bc`, never>
    >()
  ...
  it("fromIterableWith and fromIterableBy", () => {
    expect(
      Record.fromIterableWith([1, 2], (n) => {
        expect(n).type.toBe<number>()
        return [String(n), n]
      })
    ).type.toBe<Record<string, number>>()
    expect(
      Record.fromIterableWith([symA, symB], (s) => {
        expect(s).type.toBe<symbol>()
        return [String(s), s]
      })
    ).type.toBe<Record<string, symbol>>()
    expect(
      Record.fromIterableWith([1, symA], (ns) => {
  ...
  it("fromIterableBy", () => {
    expect(
      Record.fromIterableBy([1, 2], (n) => {
        expect(n).type.toBe<number>()
        return String(n)
      })
    ).type.toBe<Record<string, number>>()
    expect(
      Record.fromIterableBy([symA, symB], (s) => {
        expect(s).type.toBe<symbol>()
        return String(s)
      })
    ).type.toBe<Record<string, symbol>>()
    expect(
      Record.fromIterableBy([1, symA], (ns) => {
        expect(ns).type.toBe<number | symbol>()
  ...
  it("fromEntries", () => {
    ...
    ).type.toBe<Record<symbol, number>>()
    expect(
      Record.fromEntries([
        ["a", 1],
        [symB, 2]
      ])
    ).type.toBe<Record<string | symbol, number>>()
  })

  it("collect", () => {
    expect(
      Record.collect(string$numbers, (k, a) => {
    ...
    expect(
      Record.collect(template$numbers, (k, a) => {
    ...
    expect(
      Record.collect(string$structAB, (k, a) => {
  ...
  it("toEntries", () => {
    expect(Record.toEntries(string$numbers)).type.toBe<
      Array<[string, number]>
    >()
    expect(Record.toEntries(template$numbers)).type.toBe<
      Array<[`a${string}`, number]>
    >()
    expect(Record.toEntries(symbol$numbers)).type.toBe<
      Array<[string, number]>
    >()
    // Testing with branded records
    const brandedRecord =
      hole<Record<string & Brand.Brand<"brandedString">, number>>()
    expect(Record.toEntries(brandedRecord)).type.toBe<
      Array<[string & Brand.Brand<"brandedString">, number]>
    >()
    expect(Record.toEntries(string$structAB)).type.toBe<
      Array<["a" | "b", number]>
    >()
  })
  ...
  it("get", () => {
    ...
    expect(pipe(string$numbers, Record.get("a"))).type.toBe<
    ...
    expect(pipe(template$numbers, Record.get("a"))).type.toBe<
      Option.Option<number>
    >()
    pipe(
      template$numbers,
    ...
    expect(pipe(symbol$numbers, Record.get(symA))).type.toBe<
      Option.Option<number>
    >()
    pipe(
      symbol$numbers,
    ...
    expect(pipe(string$structAB, Record.get("a"))).type.toBe<
      Option.Option<number>
    >()
    pipe(
      string$structAB,
  ...
  it("modify, modifyOption, and replaceOption", () => {
    ...
    expect(
      pipe(
        string$numbers,
        Record.modify("a", () => true)
      )
    ).type.toBe<Record<string, number | boolean>>()
    expect(
      pipe(
        template$numbers,
        Record.modify("a", () => 2)
    ...
    ).type.toBe<Record<`a${string}`, number | boolean>>()
    pipe(
      template$numbers,
      // @ts-expect-error Argument of type
    ...
    expect(
      pipe(
        symbol$numbers,
        Record.modify(symA, () => 2)
      )
    ).type.toBe<Record<symbol, number>>()
    expect(
      pipe(
        symbol$numbers,
        Record.modify(symA, () => true)
      )
    ).type.toBe<Record<symbol, number | boolean>>()
    expect(
      pipe(
        string$structAB,
        Record.modify("a", () => 2)
      )
    ).type.toBe<Record<"a" | "b", number>>()
    expect(
      pipe(
        string$structAB,
        Record.modify("a", () => true)
      )
    ).type.toBe<Record<"a" | "b", number | boolean>>()
  })
  ...
  it("modifyOption", () => {
    expect(
      pipe(
        string$numbers,
        Record.modifyOption("a", () => 2)
      )
    ).type.toBe<Option.Option<Record<string, number>>>()
    expect(
      pipe(
        string$numbers,
        Record.modifyOption("a", () => true)
      )
    ...
    expect(
      pipe(
        symbol$numbers,
        Record.modifyOption(symA, () => 2)
      )
    ).type.toBe<Option.Option<Record<symbol, number>>>()
    expect(
      pipe(
        symbol$numbers,
        Record.modifyOption(symA, () => true)
      )
  ...
  it("replaceOption", () => {
    expect(pipe(string$numbers, Record.replaceOption("a", 2))).type.toBe<
      Option.Option<Record<string, number>>
    >()
    expect(pipe(string$numbers, Record.replaceOption("a", true))).type.toBe<
      Option.Option<Record<string, number | boolean>>
    >()
    expect(pipe(template$numbers, Record.replaceOption("a", 2))).type.toBe<
      Option.Option<Record<`a${string}`, number>>
    >()
    expect(pipe(template$numbers, Record.replaceOption("a", true))).type.toBe<
      Option.Option<Record<`a${string}`, number | boolean>>
    >()
    pipe(
      template$numbers,
      // @ts-expect-error Argument of type
    ...
    expect(pipe(symbol$numbers, Record.replaceOption(symA, 2))).type.toBe<
      Option.Option<Record<symbol, number>>
    >()
    expect(pipe(symbol$numbers, Record.replaceOption(symA, true))).type.toBe<
      Option.Option<Record<symbol, number | boolean>>
    >()
    expect(pipe(string$structAB, Record.replaceOption("a", 2))).type.toBe<
      Option.Option<Record<"a" | "b", number>>
    >()
    expect(pipe(string$structAB, Record.replaceOption("a", true))).type.toBe<
      Option.Option<Record<"a" | "b", number | boolean>>
    >()
  })

  it("remove", () => {
    expect(pipe(string$numbers, Record.remove("a"))).type.toBe<
      Record<string, number>
    >()
    expect(pipe(template$numbers, Record.remove("a"))).type.toBe<
    ...
    expect(pipe(symbol$numbers, Record.remove(symA))).type.toBe<
      Record<symbol, number>
    >()
    expect(pipe(string$structAB, Record.remove("a"))).type.toBe<
      Record<"b", number>
    >()
  })

  it("pop", () => {
    expect(pipe(string$numbers, Record.pop("a"))).type.toBe<
      Option.Option<[number, Record<string, number>]>
    >()
    ...
    expect(pipe(symbol$numbers, Record.pop(symA))).type.toBe<
      Option.Option<[number, Record<symbol, number>]>
    >()
    expect(pipe(string$structAB, Record.pop("a"))).type.toBe<
      Option.Option<[number, Record<"b", number>]>
    >()
  })

  it("map", () => {
    expect(
      Record.map(string$numbers, (v, k) => {
    ...
    expect(
      Record.map(template$numbers, (v, k) => {
        expect(v).type.toBe<number>()
        expect(k).type.toBe<`a${string}`>()
        return v > 0
      })
    ...
    expect(
      Record.map(string$structAB, (v, k) => {
        expect(v).type.toBe<number>()
        expect(k).type.toBe<"a" | "b">()
        return v > 0
      })
  ...
  it("filterMap", () => {
    expect(
      Record.filterMap(string$numbers, (v, k) => {
        expect(v).type.toBe<number>()
        expect(k).type.toBe<string>()
    ...
    expect(
      Record.filterMap(template$numbers, (v, k) => {
        expect(v).type.toBe<number>()
        expect(k).type.toBe<`a${string}`>()
        return v > 0 ? Option.some("positive") : Option.none()
      })
    ...
    expect(
      Record.filterMap(symbol$numbers, (v, k) => {
        expect(v).type.toBe<number>()
        expect(k).type.toBe<string>()
        return v > 0 ? Option.some("positive") : Option.none()
      })
    ...
    expect(
      Record.filterMap(string$structAB, (v, k) => {
        expect(v).type.toBe<number>()
        expect(k).type.toBe<"a" | "b">()
        return k === "a" ? Option.some(v) : Option.none()
      })
  ...
  it("filter", () => {
    expect(
      Record.filter(string$numbers, (v, k) => {
        expect(v).type.toBe<number>()
        expect(k).type.toBe<string>()
        return v > 0
      })
    ...
    expect(
      Record.filter(template$numbers, (v, k) => {
        expect(v).type.toBe<number>()
        expect(k).type.toBe<`a${string}`>()
        return v > 0
      })
    ...
    expect(
      Record.filter(string$structAB, (v, k) => {
        expect(v).type.toBe<number>()
        expect(k).type.toBe<"a" | "b">()
        return k === "a"
      })
    ...
    expect(Record.filter(string$numbers, predicateNumbersOrStrings)).type.toBe<
      Record<string, number>
    >()
    expect(
  ...
  it("partitionMap", () => {
    expect(
      ...
      [left: Record<string, boolean>, right: Record<string, string>]
    >()
    expect(
      pipe(
        string$structAB,
  ...
  it("partition", () => {
    expect(
      Record.partition(string$numbers, (v, k) => {
        expect(v).type.toBe<number>()
        expect(k).type.toBe<string>()
        return v > 0
      })
    ).type.toBe<
      [excluded: Record<string, number>, satisfying: Record<string, number>]
    >()
    expect(
      pipe(
        string$structAB,
    ...
    >()
    expect(
      Record.partition(string$structAB, (v, k) => {
        expect(v).type.toBe<number>()
        expect(k).type.toBe<"a" | "b">()
        return k === "a"
      })
    ...
    expect(
      ...
      [
        excluded: Record<string, string | number>,
        satisfying: Record<string, string | number>
      ]
    >()
    expect(
    ...
    expect(
      ...
      [excluded: Record<string, string>, satisfying: Record<string, number>]
    >()
    expect(
  ...
  it("set", () => {
    expect(Record.set(string$numbers, "a", 2)).type.toBe<
      Record<string, number>
    >()
    expect(Record.set(string$numbers, "a", true)).type.toBe<
      Record<string, number | boolean>
    >()
    expect(Record.set(template$numbers, "a", 2)).type.toBe<
      Record<`a${string}`, number>
    >()
    expect(Record.set(template$numbers, "a", true)).type.toBe<
      Record<`a${string}`, number | boolean>
    >()
    expect(Record.set(template$numbers, "b", true)).type.toBe<
      Record<"b" | `a${string}`, number | boolean>
    >()
    expect(Record.set(string$structAB, "a", 2)).type.toBe<
      Record<"a" | "b", number>
    >()
    expect(Record.set(string$structAB, "a", true)).type.toBe<
      Record<"a" | "b", number | boolean>
    >()
    expect(Record.set(string$structAB, "c", true)).type.toBe<
      Record<"a" | "b" | "c", number | boolean>
    >()
  })
  ...
  it("some", () => {
    expect(
      Record.some(string$structAB, (v, k) => {
        expect(v).type.toBe<number>()
        expect(k).type.toBe<"a" | "b">()
        return false
      })
  ...
  it("union", () => {
    expect(Record.union(string$numbers, string$numbers, (_, b) => b)).type.toBe<
      Record<string, number>
    >()
    expect(
  ...
  it("every", () => {
    ...
    if (Record.every(string$numbersOrStrings, Predicate.isString)) {
      expect(string$numbersOrStrings).type.toBe<
  ...
  it("intersection", () => {
    ...
    expect(
      Record.intersection(string$structAB, { c: 2 }, (a, _) => a)
    ).type.toBe<Record<never, number>>()
    expect(
      Record.intersection(string$structAB, { b: 2 }, (a, _) => a)
    ).type.toBe<Record<"b", number>>()
  })

  it("findFirst", () => {
    expect(
      Record.findFirst(string$numbersOrStrings, (a, _) =>
        predicateNumbersOrStrings(a)
      )
    ).type.toBe<Option.Option<[string, string | number]>>()
    expect(
      pipe(
        string$numbersOrStrings,
        Record.findFirst((a, _) => predicateNumbersOrStrings(a))
      )
    ).type.toBe<Option.Option<[string, string | number]>>()
    expect(
      Record.findFirst(string$numbersOrStrings, Predicate.isString)
    ).type.toBe<Option.Option<[string, string]>>()
    expect(
      pipe(string$numbersOrStrings, Record.findFirst(Predicate.isString))
    ).type.toBe<Option.Option<[string, string]>>()
  })
})
